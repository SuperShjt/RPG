...
namespace Engine
{
    public class World
    {
        ...
        public const int MONSTER_ID_GOBLINS = 5;
        public const int MONSTER_ID_DRAGON = 6;
        ...
        public const int Farmer_ID = 1;
        public const int BlackSmith_ID = 2;
        public const int Vendor_ID = 3;
        public const int Witch_ID = 4;
        ...
        {
            Items.Add(new weapons(ITEM_ID_RUSTY_SWORD, "Rusty sword", "Rusty swords", 0, 5));
            ...
            Items.Add(new weapons(ITEM_ID_CLUB, "Club", "Clubs", 3, 10));
        ...
        private static void PopulateQuests()
        {
            ...
            clearAlchemistGarden.QComplete.Add(new QuestCompletionItem(ItemByID(ITEM_ID_RAT_TAIL), 3));
            ...
            clearFarmersField.QComplete.Add(new QuestCompletionItem(ItemByID(ITEM_ID_SNAKE_FANG), 3));
